...
<div class="container"  style="margin-top: 50px;">
  <div class="row">
    ...
    <div class="col-md-5">
    <img src="assets/images/b13.jpeg" alt="Person 4" height="250",width="100" ><br><br>

    <img src="assets/images/b12.jpeg" alt="Person 4" height="250",width="100" > <br><br>

    <img src="assets/images/b9.jpeg" alt="Person 4" height="250",width="100" ><br>
        ...
        <div class="contact_form grey-bg">
          <form method="post">
